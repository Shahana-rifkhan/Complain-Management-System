<?php
  ...
  if(empty($_POST)===false){
    ...
    if(empty($TypeOfComplaint) || empty($story)){

    }else{
      mysql_query("INSERT INTO `posts` VALUES ('0','$TypeOfComplaint','$story','$session_name')") or die(mysql_error());
      $message = "
  ...
  <div class="animated fadeIn">
    ...
    <div class="div">
      <div class="col-lg-12">
          <div class="analysis">
            <?php
              $engi = mysql_query("SELECT * FROM `officer`");
          ...
          <br><br>
            ...
            $query1=mysql_query("SELECT * FROM `user` ORDER BY id DESC LIMIT 1 ");
            ...
            $query4=mysql_query("SELECT * FROM `officer` ORDER BY id DESC LIMIT 1 ");
            ...
            $new_eng=$name3['name'];
             ...
             <div class="content">
               ...
               <div class="div_data">New Officers </div>
             </div>
        ...
        <div class="post_content">
          <div class="text-center">
            ...
            <form class="" action="" method="post">
                <input type="text" class="post" name="TypeOfComplaint" placeholder="TypeOfComplaint"/><br><br>
          ...
          <div class="content"><br><br><br><br>
            <?php
              ...
              while($data=mysql_fetch_array($db)) {
                $id=$data['id'];
              echo "<div class='glow'> ";
              echo "<h4 class='heading'> Heading : ".$data['TypeOfComplaint']."</h4>";
