<?php
  ...
  $password = mysql_real_escape_string($_POST['password']);
    if(empty($email) || empty($password)){
        ...
        $query1=mysql_query("SELECT * FROM `user` WHERE id AND email='$email' and password='$password'") or die(mysql_error());
...
<html>
  ...
  <body >
    ...
    <div class="cover user text-center">
      ...
      <div class="links">
        <a href="officer-login.php">Officer</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="admin-login.php">Admin </a>
      </div>
